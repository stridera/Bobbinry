...
export default auth((req) => {
  ...
  const publicRoutes = ['/login', '/signup', '/forgot-password', '/reset-password', '/api', '/explore', '/bobbins']
  ...
  // OG image routes (generated by Next.js, no file extension)
  const isOgImage = pathname.includes('opengraph-image') || pathname.includes('twitter-image')

  // Landing page is public
  const isLandingPage = pathname === '/'

  if (!isLoggedIn && !isPublicRoute && !isPublicReader && !isLandingPage && !isOgImage) {
