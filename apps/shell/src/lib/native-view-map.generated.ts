...
export const NATIVE_VIEW_MAP: Record<string, () => Promise<any>> = {
  ...
  'discord-roles.views/settings': () => import('@bobbinry/discord-roles/views/settings'),
  ...
  'discord-notifier.views/settings': () => import('@bobbinry/discord-notifier/views/settings'),
