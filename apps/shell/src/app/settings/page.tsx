          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                disabled
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg cursor-not-allowed"
              />
            </div>
