    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fade-in">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-display text-lg font-semibold text-gray-900 dark:text-gray-100">Beta Readers & Access</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Manage beta readers and grant access to specific users.
              </p>
            </div>
            <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-display text-lg font-semibold text-gray-900 dark:text-gray-100">Notifications</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Control which emails you receive and mute individual projects.
              </p>
            </div>
            <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Default paragraph spacing, indents, scene breaks, and code-block wrap for your manuscripts. Projects and chapters can override.
              </p>
            </div>
            <Link
              href="/settings/manuscript-display"
              className="px-4 py-2 rounded-lg text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
            >
              Manage &rarr;
            </Link>
