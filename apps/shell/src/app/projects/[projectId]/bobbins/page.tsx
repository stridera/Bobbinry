...
function BobbinsContent() {
  ...
  // Header band: the tab row lists installed workspaces, so refresh it after
  // an install or uninstall lands.
  const { summary, reload: reloadSummary } = useProjectSummary(projectId)
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      <ProjectPageHeader projectId={projectId} summary={summary} pageTitle="Bobbins" />
      {/* Header */}
