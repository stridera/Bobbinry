...
const OFFICIAL_TEMPLATES: Array<{
  ...
  { shareId: 'official-characters', version: 5, label: 'Characters', icon: '🧙', description: 'People, creatures, or NPCs in your world', tags: ['rpg', 'worldbuilding', 'characters'] },
  { shareId: 'official-spells', version: 1, label: 'Spells', icon: '✨', description: 'Magical abilities and incantations', tags: ['rpg', 'magic', 'spells'] },
  { shareId: 'official-locations', version: 4, label: 'Locations', icon: '🗺️', description: 'Places, regions, and landmarks', tags: ['worldbuilding', 'locations', 'geography'] },
  { shareId: 'official-items', version: 3, label: 'Items', icon: '⚔️', description: 'Weapons, armor, magical items, and equipment', tags: ['rpg', 'items', 'equipment'] },
  ...
  { shareId: 'official-factions', version: 4, label: 'Factions', icon: '⚜️', description: 'Organizations, guilds, and political groups', tags: ['worldbuilding', 'factions', 'organizations'] },
