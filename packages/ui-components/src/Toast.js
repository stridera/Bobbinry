 ...
 * )}
 */
export function Toast({ message, variant = 'default', duration = 5000, onDismiss, dismissible = true, className = '' }) {
    useEffect(() => {
        if (duration > 0) {
    ...
    const icons = {
        default: (_jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) })),
        success: (_jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" }) })),
        ...
        danger: (_jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" }) })),
    ...
    const toastClasses = [baseClasses, variantClasses[variant], className]
        .filter(Boolean)
        .join(' ');
    return (_jsxs("div", { className: toastClasses, role: "alert", children: [_jsx("div", { className: iconClasses[variant], children: icons[variant] }), _jsx("p", { className: "flex-1 text-sm font-medium", children: message }), dismissible && onDismiss && (_jsx("button", { onClick: onDismiss, className: "flex-shrink-0 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors", "aria-label": "Dismiss", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) }))] }));
}
/**
 ...
 * </ToastContainer>
 */
export function ToastContainer({ children, position = 'top-right', className = '' }) {
    ...
    return (_jsx("div", { className: `fixed z-50 flex flex-col gap-2 ${positionClasses[position]} ${className}`, children: children }));
}
